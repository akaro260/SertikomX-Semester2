...
<button
    ...
    <div class="mr-3 hidden text-left md:block">
        <span class="block font-medium text-theme-sm">{{ Auth::user()->name }}</span>
    ...
    <div
        ...
        <!-- User Info -->
        <div>
            <span class="block mr-1 font-medium text-theme-sm text-gray-500 dark:text-gray-400">
                {{ Auth::user()->name }}
            </span>
            <span class="block mr-1 text-theme-xs text-theme-sm text-gray-500 dark:text-gray-400 mt-0.5">
                {{ Auth::user()->role }}
            </span>
